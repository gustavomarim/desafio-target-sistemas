export function initFaturamentoDiario() {
  const iniciarScript = async () => {
    const dadosResponse = await fetch('../data/faturamentoDiario.json');
    ...
    const resultadosFaturamento = [
      menorFat,
      maiorFat,
      qtdeDiasMaiorQueMediaFaturamento
    ];
